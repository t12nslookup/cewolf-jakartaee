...
public interface DatasetProducer extends Serializable {
    ...
    /**
     * By default the the name of the JSP attribute holding the
	 * producer instance is passed to the produceDataset method as a prameter.
     */
     ...
     */
    Object produceDataset(Map<String,Object> params) throws DatasetProduceException;
